...
if (!BOT_TOKEN || !SUPABASE_URL || !SUPABASE_KEY) {
  ...
  // ==================== PassPass AUTO-MATCH ====================
  /**
   * Cherche une r̩servation PassPass par property_id et date.
...
hostname: 'api.telegram.org',
  ...
  async function sauver(logement, description, typeSinistre, photos, firstMsg) {
    ...
    // Matcher le logement avec un property_id (bidirectionnel: "F̩vrier 2" match "Fevrier 2 - Lyon")
    let property_id = '';
  ...
  async function finaliserBuffer(userId) {
    ...
    // 2. Legende courte (<=50 chars) = nom du logement (ex: "F̩vrier 2", "BERLIOZ 69100")
    // Note: ne pas filtrer les noms de mois - "F̩vrier 2" est un nom d'appartement valide
    let logement = null;
